...
class connectionUA {
    ...
    connectionUA() {
        try {
            ...
            con = DriverManager.getConnection(
                    "jdbc:mysql://capstoneproject.ck3v6fmgoed4.us-east-2.rds.amazonaws.com/PasswordManager", "admin",
                    "itsc4155group3");
    ...
    void insert(String text3, String text4, String text5, String text6, String text7) throws Exception {
        ps = con.prepareStatement(
                "INSERT INTO accountmanager (username, firstname, lastname, password)" + " VALUES (?,?,?,?)");
        ps.setString(1, text3);
        ...
        butt3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    con.insert(text3.getText().toString(), text4.getText().toString(), text5.getText().toString(),
