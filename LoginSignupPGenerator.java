...
class SignUp extends JFrame{
	...
	JButton butt3, generateButton;
	JLabel label3,label6,label7,label8,label9,label10, passwordLabel;
    SignUp(){
    	setLayout(null);
        ...
        passwordLabel = new JLabel("Password: "); // new label
        passwordLabel.setBounds(25, 260, 300, 30);
        add(passwordLabel);
        
        text3 = new JTextField(60);
        text4 = new JTextField(60);
        text5 = new JTextField(60);
        text6 = new JTextField(60);
        text7 = new JTextField(60);
        ...
        generateButton = new JButton("Generate Password"); // new button
        generateButton.setBounds(250, 180, 150, 30);
        add(generateButton);
        ...
        generateButton.addActionListener(new ActionListener() { // new action listener
            public void actionPerformed(ActionEvent ae) {
                String password = generatePassword(); // generate a password
                text6.setText(password); // set the password field to the generated password
            }
        });
